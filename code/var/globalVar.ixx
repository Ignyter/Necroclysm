...
export std::queue<CircuitKey> saveFrontierQueue;
export std::unordered_set<CircuitKey, CircuitKey::Hash> saveVisitedSet;

export std::queue<CircuitKey> nextCircuitStartQueue; //전자스위치로 상태가 변경된 네트워크를 다시 계산할 때의 시작점 좌표들
